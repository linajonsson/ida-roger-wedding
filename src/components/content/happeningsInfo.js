export const happeningsInfo = [
  {
    header: "Fredag",
    image: "",
    events: [
      "Ankomst till Relais Sant’Uffizio. (Incheckning för tillgång till rum från kl. 15.00).",
      "Pizzamiddag, birra moretti, prosecco och gott häng så länge man vill och orkar på Relais Sant’Uffizio. ",
    ],
  },
  {
    ...
    events: [
      ...
      "Bröllopsmiddag med italienska smaker och viner från Piemonte",
      "FEST!",
    ],
  },
  {
